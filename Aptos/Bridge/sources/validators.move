module dev::QiaraValidatorsV21 {
    ...
    use dev::QiaraSharedV4::{Self as Shared, Access as SharedAccess};
    use dev::QiaraGenesisV2::{Self as Genesis};
    use dev::QiaraStorageV7::{Self as storage};
    use dev::QiaraTokensQiaraV16::{Self as TokensQiara};
    ...
    fun init_module(admin: &signer) {
        ...
        move_to(admin, PerEpoch {total_credits: 0, emissions: (TokensQiara::calculate_emissions() as u256),  total_weight: 0, total_staked: Margin::get_total_staked_usd(), vote_weights: map::new<String, u256>()});
