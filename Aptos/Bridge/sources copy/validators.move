module dev::QiaraValidatorsV16 {
    ...
    use dev::QiaraSharedV1::{Self as Shared, Access as SharedAccess};
    ...
    // Interface for changing validator EVM address on-chain
    public entry fun change_validator_evm_address(signer: &signer, shared: String, pubkey_evm_address: vector<u8>) acquires Validators {
        Shared::assert_is_sub_owner(shared, bcs::to_bytes(&signer::address_of(signer)));
        ...
        Event::emit_consensus_event(utf8(b"Change Validator EVM Address"), data);
    }
    ...
    public fun c_register_validator(signer: &signer, shared: String, validator: vector<u8>, pub_key: vector<u8>, pubkey_evm_address: vector<u8>, _perm: Permission
