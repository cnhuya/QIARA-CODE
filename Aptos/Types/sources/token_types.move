module dev::QiaraTokenTypesV43 {
    ...
    const TOKEN_PREFIX: vector<u8> = b"Qiara119 ";
...
fun x_init(signer: &signer) acquires Tokens {
    ...
    register_token_with_chains(signer, utf8(b"Qiara119 Qiara"), utf8(b"Qiara"), 
    ...
    register_token_with_chains(signer, utf8(b"Qiara119 Solana"), utf8(b"Solana"), 
        vector[utf8(b"0x0")], 
        vector[utf8(b"Solana")]
    );

    register_token_with_chains(signer, utf8(b"Qiara119 syrupUSDC"), utf8(b"syrupUSDC"), 
        vector[utf8(b"0x0")], 
        vector[utf8(b"Solana")]
    );

    register_token_with_chains(signer, utf8(b"Qiara119 USDG"), utf8(b"USDG"), 
        vector[utf8(b"0x0"), utf8(b"0x0")], 
        vector[utf8(b"Solana"), utf8(b"Robinhood")]
    );

    register_token_with_chains(signer, utf8(b"Qiara119 jupUSD"), utf8(b"jupUSD"), 
        vector[utf8(b"0x0")], 
        vector[utf8(b"Solana")]
    );

    register_token_with_chains(signer, utf8(b"Qiara119 JLP"), utf8(b"JLP"), 
        vector[utf8(b"0x0")], 
        vector[utf8(b"Solana")]
    );
    ...
    register_token_with_chains(signer, utf8(b"Qiara119 Burned Qiara"), utf8(b"Burned Qiara"), 
        vector[utf8(b"0x0")], 
        vector[utf8(b"Aptos")]
    );

    // USDC: Moved real address to index 1 (Base), index 0 (Sui) is now 0x0
    register_token_with_chains(signer, utf8(b"Qiara119 USDC"), utf8(b"USDC"), 
        vector[utf8(b"0x0"), utf8(b"0x0D5322Af414db3bd855cC44424F8532859469957"), utf8(b"0x0"), utf8(b"0x0"), utf8(b"0x0"), utf8(b"0x0")], 
        vector[utf8(b"Sui"), utf8(b"Base"), utf8(b"Aptos"), utf8(b"Monad"), utf8(b"Ethereum"), utf8(b"Solana")]
    );
    
    // USDT: 4 chains -> 4 placeholders
    register_token_with_chains(signer, utf8(b"Qiara119 USDT"), utf8(b"USDT"), 
    ...
    register_token_with_chains(signer, utf8(b"Qiara119 USDT0"), utf8(b"USDT0"), vector[utf8(b"0x0"), utf8(b"0x0")], vector[utf8(b"Monad"), utf8(b"Aptos")]);
    register_token_with_chains(signer, utf8(b"Qiara119 AUSD"), utf8(b"AUSD"), vector[utf8(b"0x0"), utf8(b"0x0")], vector[utf8(b"Monad"), utf8(b"Aptos")]);
    register_token_with_chains(signer, utf8(b"Qiara119 earnAUSD"), utf8(b"earnAUSD"), vector[utf8(b"0x0"), utf8(b"0x0")], vector[utf8(b"Monad"), utf8(b"Aptos")]);

    // Ethereum: 5 chains -> 5 placeholders
    register_token_with_chains(signer, utf8(b"Qiara119 Ethereum"), utf8(b"Ethereum"), 
    ...
    register_token_with_chains(signer, utf8(b"Qiara119 Bitcoin"), utf8(b"Bitcoin"),
        vector[utf8(b"0x0"), utf8(b"0x0"), utf8(b"0x0"), utf8(b"0x0"), utf8(b"0x0"), utf8(b"0x0")], 
        vector[utf8(b"Sui"), utf8(b"Monad"), utf8(b"Ethereum"), utf8(b"Base"), utf8(b"Aptos"), utf8(b"Solana")]
    );
    
    // Monad: 2 chains -> 2 placeholders
    register_token_with_chains(signer, utf8(b"Qiara119 Monad"), utf8(b"Monad"), vector[utf8(b"0x0"), utf8(b"0x0")], vector[utf8(b"Monad"), utf8(b"Aptos")]);
    
    // Aptos: 1 chain -> 1 placeholder
    register_token_with_chains(signer, utf8(b"Qiara119 Aptos"), utf8(b"Aptos"), 
        vector[utf8(b"0x0")], 
        vector[utf8(b"Aptos")]
    );
    
    // Sui & Deepbook: 2 chains -> 2 placeholders
    register_token_with_chains(signer, utf8(b"Qiara119 Sui"), utf8(b"Sui"), vector[utf8(b"0x0"), utf8(b"0x0")], vector[utf8(b"Sui"), utf8(b"Aptos")]);
    register_token_with_chains(signer, utf8(b"Qiara119 Deepbook"), utf8(b"Deepbook"), vector[utf8(b"0x0"), utf8(b"0x0")], vector[utf8(b"Sui"), utf8(b"Aptos")]);
    
    // Virtuals: 3 chains -> 3 placeholders
    register_token_with_chains(signer, utf8(b"Qiara119 Virtuals"), utf8(b"Virtuals"), 
