module dev::QiaraTokenTypesV72 {
    ...
    const TOKEN_PREFIX: vector<u8> = b"Qiara146 ";
    ...
    fun x_init(signer: &signer) acquires Tokens {
        register_token_with_chains(signer, utf8(b"Qiara146 Qiara"), utf8(b"Qiara"), 
            vector[
        ...
        register_token_with_chains(signer, utf8(b"Qiara146 Solana"), utf8(b"Solana"), 
            vector[utf8(b"AhC5BeQ238gzcoZ174B1xup4hnT1ckL5Tw3jS2Lph754")], 
            vector[utf8(b"Solana")],
            vector[8u8]
        );
        register_token_with_chains(signer, utf8(b"Qiara146 USDG"), utf8(b"USDG"), 
        ...
        register_token_with_chains(signer, utf8(b"Qiara146 JLP"), utf8(b"JLP"), 
            vector[utf8(b"CVi7oUumG14WjyWPSpdEQiHTBTfZTRX76c2KEKjQKRUr")], 
            vector[utf8(b"Solana")],
            vector[8u8]
        );
        register_token_with_chains(signer, utf8(b"Qiara146 Burned Qiara"), utf8(b"Burned Qiara"), 
            vector[utf8(b"0x0")], 
            vector[utf8(b"Aptos")],
            vector[8u8]
        );
        register_token_with_chains(signer, utf8(b"Qiara146 USDC"), utf8(b"USDC"), 
            vector[
        ...
        register_token_with_chains(signer, utf8(b"Qiara146 USDT"), utf8(b"USDT"), 
            vector[
        ...
        register_token_with_chains(signer, utf8(b"Qiara146 AUSD"), utf8(b"AUSD"), 
            vector[utf8(b"0xef2b49A7B11b61eeFce6c5a0C0466D13e6C7aeA7"), utf8(b"0x0")], 
            vector[utf8(b"Monad"), utf8(b"Aptos")],
            vector[18u8, 8u8]
        );
        register_token_with_chains(signer, utf8(b"Qiara146 earnAUSD"), utf8(b"earnAUSD"), 
            vector[utf8(b"0x54328f1bD6438A8EE35CdeB412233511008F8B06"), utf8(b"0x0")], 
            vector[utf8(b"Monad"), utf8(b"Aptos")],
            vector[18u8, 8u8]
        );
        register_token_with_chains(signer, utf8(b"Qiara146 Ethereum"), utf8(b"Ethereum"), 
            vector[
        ...
        register_token_with_chains(signer, utf8(b"Qiara146 Bitcoin"), utf8(b"Bitcoin"),
            vector[
        ...
        register_token_with_chains(signer, utf8(b"Qiara146 Monad"), utf8(b"Monad"), 
            vector[utf8(b"0x860d01d42D8557F9A2f9725ef86Af24d1CDa3AE8"), utf8(b"0x0")], 
            vector[utf8(b"Monad"), utf8(b"Aptos")],
            vector[18u8, 8u8]
        );
        register_token_with_chains(signer, utf8(b"Qiara146 Aptos"), utf8(b"Aptos"), 
            vector[utf8(b"0x0")], 
            vector[utf8(b"Aptos")],
            vector[8u8]
        );
        register_token_with_chains(signer, utf8(b"Qiara146 Sui"), utf8(b"Sui"), 
        ...
        register_token_with_chains(signer, utf8(b"Qiara146 Deepbook"), utf8(b"Deepbook"), 
            vector[utf8(b"0x072651bd55f5894dea1fd9733b85409f1e16680ea2476fe2398b17904b8df7bc::DEEP::DEEP"), utf8(b"0x0")], 
            vector[utf8(b"Sui"), utf8(b"Aptos")],
            vector[8u8, 6u8]
        );
        register_token_with_chains(signer, utf8(b"Qiara146 Virtuals"), utf8(b"Virtuals"), 
