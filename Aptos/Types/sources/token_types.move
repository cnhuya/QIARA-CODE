module dev::QiaraTokenTypesV8 {
    ...
    const TOKEN_PREFIX: vector<u8> = b"Qiara84 ";
...
fun x_init(signer: &signer) acquires Tokens {
    ...
    register_token_with_chains(signer, utf8(b"Qiara84 Qiara"), utf8(b"Qiara"), 
    ...
    register_token_with_chains(signer, utf8(b"Qiara84 Burned Qiara"), utf8(b"Burned Qiara"), 
        vector[utf8(b"0x0")], 
        vector[utf8(b"Aptos")]
    );

    // USDC: Moved real address to index 1 (Base), index 0 (Sui) is now 0x0
    register_token_with_chains(signer, utf8(b"Qiara84 USDC"), utf8(b"USDC"), 
    ...
    register_token_with_chains(signer, utf8(b"Qiara84 USDT"), utf8(b"USDT"), 
    ...
    register_token_with_chains(signer, utf8(b"Qiara84 USDT0"), utf8(b"USDT0"), vector[utf8(b"0x0"), utf8(b"0x0")], vector[utf8(b"Monad"), utf8(b"Aptos")]);
    register_token_with_chains(signer, utf8(b"Qiara84 AUSD"), utf8(b"AUSD"), vector[utf8(b"0x0"), utf8(b"0x0")], vector[utf8(b"Monad"), utf8(b"Aptos")]);
    register_token_with_chains(signer, utf8(b"Qiara84 earnAUSD"), utf8(b"earnAUSD"), vector[utf8(b"0x0"), utf8(b"0x0")], vector[utf8(b"Monad"), utf8(b"Aptos")]);

    // Ethereum: 5 chains -> 5 placeholders
    register_token_with_chains(signer, utf8(b"Qiara84 Ethereum"), utf8(b"Ethereum"), 
        vector[utf8(b"0x0"), utf8(b"0x0"), utf8(b"0x0"), utf8(b"0x0"), utf8(b"0x0")], 
        vector[utf8(b"Sui"), utf8(b"Base"), utf8(b"Aptos"), utf8(b"Monad"), utf8(b"Ethereum")]
    );
    
    // Bitcoin: 5 chains -> 5 placeholders
    register_token_with_chains(signer, utf8(b"Qiara84 Bitcoin"), utf8(b"Bitcoin"),
        vector[utf8(b"0x0"), utf8(b"0x0"), utf8(b"0x0"), utf8(b"0x0"), utf8(b"0x0")], 
        vector[utf8(b"Sui"), utf8(b"Monad"), utf8(b"Ethereum"), utf8(b"Base"), utf8(b"Aptos")]
    );
    
    // Monad: 2 chains -> 2 placeholders
    register_token_with_chains(signer, utf8(b"Qiara84 Monad"), utf8(b"Monad"), vector[utf8(b"0x0"), utf8(b"0x0")], vector[utf8(b"Monad"), utf8(b"Aptos")]);
    
    // Aptos: 1 chain -> 1 placeholder
    register_token_with_chains(signer, utf8(b"Qiara84 Aptos"), utf8(b"Aptos"), 
        vector[utf8(b"0x0")], 
        vector[utf8(b"Aptos")]
    );
    
    // Sui & Deepbook: 2 chains -> 2 placeholders
    register_token_with_chains(signer, utf8(b"Qiara84 Sui"), utf8(b"Sui"), vector[utf8(b"0x0"), utf8(b"0x0")], vector[utf8(b"Sui"), utf8(b"Aptos")]);
    register_token_with_chains(signer, utf8(b"Qiara84 Deepbook"), utf8(b"Deepbook"), vector[utf8(b"0x0"), utf8(b"0x0")], vector[utf8(b"Sui"), utf8(b"Aptos")]);
    
    // Virtuals: 3 chains -> 3 placeholders
    register_token_with_chains(signer, utf8(b"Qiara84 Virtuals"), utf8(b"Virtuals"), 
