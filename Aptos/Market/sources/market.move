module dev::QiaraVaultsV60 {
    ...
    use dev::QiaraTokensCoreV44::{Self as TokensCore, CoinMetadata, Access as TokensCoreAccess};
    use dev::QiaraTokensMetadataV44::{Self as TokensMetadata, VMetadata, Access as TokensMetadataAccess};
    use dev::QiaraTokensTiersV44::{Self as TokensTiers};
    use dev::QiaraWrapperGateV44::{Self as WrapperGate};

    use dev::QiaraMarginV44::{Self as Margin, Access as MarginAccess};
    use dev::QiaraRanksV44::{Self as Points, Access as PointsAccess};
    use dev::QiaraRIV44::{Self as RI};
    use dev::QiaraBurnedQiaraV44::{Self as BurnedQiara};

    use dev::QiaraTokenTypesV44::{Self as TokensTypes};
    ...
    use dev::QiaraLiquidityV59::{Self as Liquidity, Access as LiquidityAccess};
...
// === CONSENSUS INTERFACE === //
    ...
    public fun c_bridge_deposit(validator: &signer, shared: String, sender: vector<u8>, token: String, chain: String, provider: String, amount: u64, lend_rate: u64, reward: u64, permission: Permission) acquires Permissions {
        ...
        let (total_rewards, total_interest, user_borrow_interest, user_lend_rewards, user_points, total_apr, borrow_apr, utilization, price, user_gas_reducted, user_xp_increased) = new_accrue(shared, sender, token, chain, provider);
