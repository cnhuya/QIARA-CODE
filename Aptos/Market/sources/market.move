module dev::QiaraVaultsV44 {
    ...
    use dev::QiaraTokensCoreV34::{Self as TokensCore, CoinMetadata, Access as TokensCoreAccess};
    use dev::QiaraTokensMetadataV34::{Self as TokensMetadata, VMetadata, Access as TokensMetadataAccess};
    use dev::QiaraTokensRatesV34::{Self as TokensRates, Access as TokensRatesAccess};
    ...
    use dev::QiaraRanksV28::{Self as Points, Access as PointsAccess};
    use dev::QiaraRIV28::{Self as RI};
    use dev::QiaraBurnedQiaraV28::{Self as BurnedQiara};

    use dev::QiaraTokenTypesV34::{Self as TokensTypes};
    use dev::QiaraChainTypesV34::{Self as ChainTypes};
    use dev::QiaraProviderTypesV34::{Self as ProviderTypes};
    ...
    use dev::QiaraLiquidityV43::{Self as Liquidity, Access as LiquidityAccess};
    use dev::QiaraTokenVaultsV43::{Self as TokenVaults, Access as TokenVaultsAccess};
...
// === CONSENSUS INTERFACE === //
    ...
    public fun c_bridge_deposit(validator: &signer, shared: String, sender: vector<u8>, token: String, chain: String, provider: String, amount: u64, lend_rate: u64, permission: Permission) acquires Permissions {
        ...
        let (total_rewards, total_interest, user_borrow_interest, user_lend_rewards, user_points, total_apr, borrow_apr, utilization, price) = new_accrue(shared, sender, token, chain, provider);
...
// === NATIVE INTERFACE === //
    ...
    public entry fun stake(signer: &signer, shared: String, token: String, chain: String, provider: String, amount: u64) acquires Permissions {
        ...
        let (total_rewards, total_interest, user_borrow_interest, user_lend_rewards,  user_points, total_apr, borrow_apr, utilization, price) = new_accrue(shared, bcs::to_bytes(&signer::address_of(signer)), token, chain, provider);
        let data = vector[
...
// === HELPERS === //
    ...
    public fun new_accrue(shared: String, user: vector<u8>, token: String, chain: String, provider: String): (u256, u256, u256, u256, u256, u256, u256, u256, u256) acquires Permissions {
