module dev::QiaraTokensCoreV9{
    ...
    use dev::QiaraStoragesV10::{Self as Storages};
...
// === CONSENSUS FUNCTIONS === //
    ...
    public fun c_bridge_to_supra(validator: &signer, shared: String, user: vector<u8>, symbol: String, chain: String, provider: String, amount: u64, rate: u64, perm: Permission) acquires Permissions, ManagedFungibleAsset{
        ...
        TokensRates::update_rate(symbol, chain, provider, rate, TokensOmnichain::give_permission(&borrow_global<Permissions>(@dev).tokens_rates_access));
