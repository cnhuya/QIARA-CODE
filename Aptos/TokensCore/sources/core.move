module dev::QiaraTokensCoreV32{
    ...
    use dev::QiaraTokensQiaraV32::{Self as TokensQiara,  Access as TokensQiaraAccess};
    ...
    use dev::QiaraStoragesV32::{Self as Storages};
    ...
    fun init_token(admin: &signer, name: String, symbol: String, icon: String, creation: u64,oracleID: vector<u8>, max_supply: u128, circulating_supply: u128, total_supply: u128, stable:u8 ){
       ...
       // tttta(109);
        ...
        let deposit = function_info::new_function_info(
            admin,
            string::utf8(b"QiaraTokensCoreV32"),
