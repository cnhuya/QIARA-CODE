module dev::QiaraTokensMetadataV69{
    use std::signer;
    ...
    use dev::QiaraTokensTiersV69::{Self as tier};
    use dev::QiaraTokenTypesV69::{Self as TokensType, TokenChainData};
        ...
        public fun get_coin_metadata_by_symbol(res: String): VMetadata acquires Tokens {
            ...
            while (len > 0) {
                ...
                if (metadat.symbol == res) {
                    // In QiaraTokensMetadataV69::get_coin_metadata_by_symbol:
                    let (_, price_decimals) = oracle::get_raw_price(metadat.oracleID);
