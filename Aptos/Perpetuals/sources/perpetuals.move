module dev::QiaraPerpsV49 {
    ...
    use dev::QiaraRanksV59::{Self as Ranks, Access as RanksAccess};
    ...
    use dev::QiaraLiquidityV77::{Self as Liquidity};
    ...
    use dev::QiaraPerpsOrdersV49::{Self as Orders};
