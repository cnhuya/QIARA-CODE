module dev::QiaraPerpsV52 {
    ...
    use dev::QiaraRanksV62::{Self as Ranks, Access as RanksAccess};
    ...
    use dev::QiaraLiquidityV81::{Self as Liquidity};
    ...
    use dev::QiaraPerpsOrdersV52::{Self as Orders};
