module dev::QiaraPerpsV59 {
    ...
    use dev::QiaraRanksV70::{Self as Ranks, Access as RanksAccess};
    ...
    use dev::QiaraLiquidityV88::{Self as Liquidity};
    ...
    use dev::QiaraPerpsOrdersV59::{Self as Orders};
