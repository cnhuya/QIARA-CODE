module dev::QiaraPerpsV56 {
    ...
    use dev::QiaraRanksV66::{Self as Ranks, Access as RanksAccess};
    ...
    use dev::QiaraLiquidityV85::{Self as Liquidity};
    ...
    use dev::QiaraPerpsOrdersV56::{Self as Orders};
